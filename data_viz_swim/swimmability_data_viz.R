...
flare_forecast_s3 <- arrow::s3_bucket(file.path('bio230121-bucket01/flare/forecasts/parquet/site_id=sunp/model_id=glm_flare_v3',paste0("reference_date=",forecast_date)),
